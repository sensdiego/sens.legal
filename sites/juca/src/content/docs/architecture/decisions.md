...
**Context:** Knowledge graph data needed both local dev (JSON files, ~1M edges) and production (Neo4j Aura) access paths. The canonical KG now lives in Valter with 77,828 nodes and 128,021 edges in multi-tribunal production (schema v2.1, 5,310 decisions fully processed), plus a 2.2M classified corpus.
